...
The cover image background is from [Josh Calabrese](https://unsplash.com/photos/XXpbdU_31Sg). Text typed with [Outfit](https://nanx.me/ost/outfit.html).

The favicon is made with [Inconsolata](https://nanx.me/ost/inconsolata.html).
