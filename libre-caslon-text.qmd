...
<a href="https://fonts.google.com/specimen/Libre+Caslon+Text" class="btn btn-outline-secondary" role="button" target="_blank">
<i class="bi bi-box-arrow-up-right"></i>
Google Fonts
</a>
<a href="https://github.com/impallari/Libre-Caslon-Text" class="btn btn-outline-secondary" role="button" target="_blank">
<i class="bi bi-box-arrow-up-right"></i>
GitHub
</a>
