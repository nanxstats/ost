...
```{r}
htmltools::tagList(
  btn_link("https://fonts.google.com/specimen/Cormorant+Garamond", "Google Fonts"),
  btn_link("https://github.com/CatharsisFonts/Cormorant", "GitHub")
)
```
...
```{css}
.live { font-family: "Cormorant Garamond", serif; }
```
