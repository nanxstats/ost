...
```{r}
htmltools::tagList(
  btn_link("https://fonts.google.com/specimen/STIX+Two+Text", "Google Fonts"),
  btn_link("https://github.com/stipub/stixfonts", "GitHub")
)
```
...
```{css}
.live { font-family: "STIX Two Text", serif; }
```
