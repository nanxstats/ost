...
```{r}
htmltools::tagList(
  btn_link("https://fonts.google.com/specimen/Source+Serif+Pro", "Google Fonts (Source Serif Pro)"),
  btn_link("https://fonts.google.com/specimen/Source+Serif+4", "Google Fonts (Source Serif 4)"),
